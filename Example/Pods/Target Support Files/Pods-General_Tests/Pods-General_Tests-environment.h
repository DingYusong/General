...
// General
#define COCOAPODS_POD_AVAILABLE_General
#define COCOAPODS_VERSION_MAJOR_General 0
#define COCOAPODS_VERSION_MINOR_General 1
#define COCOAPODS_VERSION_PATCH_General 0
